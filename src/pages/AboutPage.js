...
const teamMembers = [
  {
    name: '강영규',
    role: '테라폼, 도커 스크립트 파일, 백엔드',
    bio: '본인 파트는 본인이 정해오시오',
  },
  {
    name: '김건',
    role: '쿠버네티스, 프론트엔드 & 백엔드',
    bio: '본인 파트는 본인이 정해오시오',
  },
  {
    name: '노을',
  ...
  {
    name: '남지민',
    role: 'CI/CD, 스크립트 파일 작성',
    bio: '본인 파트는 본인이 정해오시오',
  },
  {
    name: '허유림',
    role: '모니터링, 프론트엔드, Git 스크립트 파일',
    bio: '전반적인 프론트엔드 담당 및 모니터링과 Git 스크립트 파일 작성, 문서화',
  },
];
...
const features = [
  {
    title: '실전 프로젝트',
    description: '실제 기업 환경과 유사한 프로젝트로 실무 경험을 쌓아보세요.',
    Icon: FaProjectDiagram,
  },
  {
    title: '전문가 멘토링',
    description: '업계 전문가들의 1:1 코칭으로 빠르게 성장하세요.',
    Icon: FaUsers,
  },
  {
    title: '자동화 도구',
    description: '자동화 기술로 효율적인 워크플로우를 만드세요.',
    Icon: FaTools,
  },
  {
    title: 'DevOps 교육',
    description: '체계적이고 실용적인 교육으로 커리어를 시작하세요.',
    Icon: FaTools,
  },
];
        ...
        <div className="container p-8 bg-white ">
          ...
          <main className="container mx-auto px-4 py-16">
            ...
            <section className="mb-20">
              ...
              >
                DevRail은 DevOps 기술을 학습할 수 있는 플랫폼으로, 개발자들이
                실무에 필요한 기술을 체계적으로 배울 수 있도록 설계되었습니다.
              </motion.p>
            </section>
              ...
              <div className="bg-gray-100 rounded-lg p-8 shadow-lg space-y-6">
                ...
                >
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      DevRail 프로젝트는 단순히 이론을 배우는 것을 넘어, 실제
                      DevOps 환경에서 사용하는 기술을 직접 경험하기 위해
                      시작되었습니다. 실무에서 활용 가능한 기술을 익히는 것이
                      목표였습니다.
                    </p>
                  </div>
                </motion.div>
                ...
                >
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      프로젝트를 진행하며 각 팀원이 맡은 역할에서 전문성을 쌓고,
                      협업을 통해 DevOps 환경에서의 팀워크와 문제 해결 능력을
                      배울 수 있었습니다.
                    </p>
                  </div>
                </motion.div>
                ...
                >
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      DevRail은 단순한 프로젝트를 넘어, 실제로 사용할 수 있는
                      기술을 익히며 미래 커리어를 위한 발판을 마련한 소중한
                      경험이 되었습니다.
                    </p>
                  </div>
                </motion.div>
                ...
                >
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      프로젝트 과정에서 직면한 도전 과제를 해결하며 성장했고,
                      이를 통해 새로운 기술을 배우는 것에 대한 자신감을 얻게
                      되었습니다.
                    </p>
                  </div>
                </motion.div>
